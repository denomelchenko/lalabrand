...
ALTER TABLE `item_info` ADD FOREIGN KEY (`item_id`) REFERENCES `item` (`id`);

ALTER TABLE `wishlist_item` ADD FOREIGN KEY (`wishlist_id`) REFERENCES `wishlist` (`id`);

ALTER TABLE `wishlist_item` ADD FOREIGN KEY (`item_id`) REFERENCES `item` (`id`);
...
ALTER TABLE `cart_item` ADD FOREIGN KEY (`size_id`) REFERENCES `size` (`id`);

ALTER TABLE `cart_item` ADD FOREIGN KEY (`item_info_id`) REFERENCES `item_info` (`item_id`);